...
<div  x-data="{ isOpen: false}" class="p-4 h-svh w-full rounded-lg dark:border-gray-700 mt-14">
    ...
    <div class="w-full flex justify-between mb-4 items-center">
        ...
        <?php require base_path("Http/views/customers/delete.php") ?>
    </div>
    ...
    <div  class="mb-12 md:h-fit  overflow-auto sm:max-w-[78%] bg-white rounded-lg shadow dark:bg-gray-700">
        <div class="flex items-center justify-between p-4 md:p-2 border-b rounded-t dark:border-gray-600">
            ...
            <button @click="isOpen = true" class="bg-orange-500 h-12 block
            text-white
        ...
        <div class="p-4 overflow-x-auto shadow-md bg-white sm:rounded-lg">
