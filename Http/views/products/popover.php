...
>
    <div x-show="isOpen"
         ...
         :style="`left: ${currentTarget.offsetLeft}px; top: ${currentTarget.offsetTop + currentTarget.offsetHeight}px;`"
         role="tooltip"
         class="z-10 inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm w-80 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
        <div class="p-3">
            <div class="flex">
                <div class="me-3 shrink-0">
                    <a href="#" class="block p-2 bg-gray-100 rounded-lg dark:bg-gray-700">
                        <img class="w-8 h-8 rounded-full" :src="imageSrc" alt="Flowbite logo">
                    </a>
                </div>
                <div>
