    ...
    <div class="w-full h-fit sm:h-[90%] grid sm:grid-cols-[20%_78%] gap-4 mb-2">
        ...
        <div class="w-full p-4 bg-white border border-gray-200 sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <div class="flex items-center justify-between mb-4">
                <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Message</h5>
                    ...
                    <li class="py-3 sm:py-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <img class="w-8 h-8 rounded-full" src="/images/kuromi.jpg"
                                     alt="Neil image">
                            </div>
        ...
        <!--        Main Chat Window-->
        <div class="hidden sm:grid grid-rows-[10%_80%_10%] w-full bg-white border border-gray-200">
            <!--            User Details-->
            <div class="p-3 sm:p-4 w-full flex justify-between border-b border-gray-50">
                <div class="flex items-center ">
                    <div class="flex-shrink-0">
                        <img class="w-10 h-10 rounded-full" src="images/kuromi.jpg"
                             alt="Neil image">
                    </div>
                    <div class="flex-1 min-w-0 ms-4">
            ...
            <div class="p-3 bg-white sm:p-4 w-full flex flex-col gap-2">
                ...
                <div class="flex items-start gap-2.5">
                    <img class="w-8 h-8 rounded-full" src="/images/kuromi.jpg" alt="Jese image">
